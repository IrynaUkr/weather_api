...
public class WeatherManagerRepositoryTests {
    ...
    public void testFindAllAdviceText() {
        ...
        Advice advice2 = new Advice(2L, 1, "10","20", "Temperature is chilly, wear a light jacket");
        Advice advice3 = new Advice(3L, 2, "0.1","7.9", "No wind...");

        weatherManagerRepository.save(advice1);
        weatherManagerRepository.save(advice2);
        weatherManagerRepository.save(advice3);

        Iterable<Advice> adviceList = weatherManagerRepository.findAll();
        assertThat(adviceList).hasSize(3);
    }
